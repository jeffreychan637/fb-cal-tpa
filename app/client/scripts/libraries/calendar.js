...
(function($) {
	...
	Calendar.prototype._render = function() {
		...
		if(getExtentedOption(this, 'first_day') == 1) {
			if ($(window).width() > 630) {
				...
				data.months = [this.locale.sd1, this.locale.sd2, this.locale.sd3, this.locale.sd4, this.locale.sd5, this.locale.sd6, this.locale.sd0]
			}
		} else {
			if ($(window).width() > 630) {
				data.months = [this.locale.d0, this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6]
			} else {
				data.months = [this.locale.sd0, this.locale.sd1, this.locale.sd2, this.locale.sd3, this.locale.sd4, this.locale.sd5, this.locale.sd6]
			}
		}
		...
		switch(this.options.view) {
			case 'month':
				this._calculate_hour_minutes_for_month(data);
				break;
			case 'week':
	...
	Calendar.prototype._calculate_hour_minutes_for_month = function(data) {
		var $self = this;
	...
	/* Used for Hex to RGB conversion */
